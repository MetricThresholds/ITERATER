...
File: RQ2_EASC_on_al_test_spv.py
...
def easc_on_tal_test(working_dir, result_dir):
    ...
    for project_t in projects_t:
        ...
        for name in versions_sorted:
            ...
            gnb.fit(df_name_previous.loc[:, metrics_20], df_name_previous.loc[:, 'bugBinary'])
...
if __name__ == '__main__':
    ...
    easc_on_tal_test(work_Directory, result_Directory)
